package yams.motorcontrollers.talonfxs;
...
public class SMCPivot {
    ...
    private TalonFXS motorController;
    private Pivot arm;
    @BeforeEach
    void startThread() {
        ...
        motorController = new TalonFXS((int)(Math.random()*50));
        ...
        controller = new TalonFXSWrapper(motorController, DCMotor.getNEO(1), config);
