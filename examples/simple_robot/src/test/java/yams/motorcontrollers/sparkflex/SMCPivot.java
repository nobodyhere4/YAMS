package yams.motorcontrollers.sparkflex;
...
public class SMCPivot {
    ...
    private SparkFlex motorController;
    private Pivot arm;
    @BeforeEach
    void startThread() {
        ...
        motorController = new SparkFlex((int)(Math.random()*50), SparkLowLevel.MotorType.kBrushless);
        ...
        controller = new SparkWrapper(motorController, DCMotor.getNeoVortex(1), config);
