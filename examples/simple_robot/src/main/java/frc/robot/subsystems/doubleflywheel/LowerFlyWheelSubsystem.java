...
/**
 * Lower Flywheel subsystem, separated to allow for live tuning and sysId.
 */
public class LowerFlyWheelSubsystem extends SubsystemBase
{
  ...
  private SmartMotorController flyWheel = new TalonFXWrapper(new TalonFX(4),
  ...
  public Command setDistance(Supplier<Distance> distanceSupplier)
  {
    return run(() -> {
      ...
      flyWheel.setVelocity(lowerSpeeds);
